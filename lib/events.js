...
import { isStaffSender, isBot, identify, isSharedSender, staffLabel } from './team.js';
import { attributeHost } from './facts.js';
...
export function factsFromEvents(ev, { now = Date.now() } = {}) {
