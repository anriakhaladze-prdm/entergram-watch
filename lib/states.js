...
export const STATES = [
  ...
  { key: 'barred',     label: 'Time-barred',     short: 'Time-barred', tone: 'gray',  blurb: 'no message either way for 20 days or more' },
  { key: 'left',       label: 'Player left',     short: 'Left',       tone: 'purple', blurb: 'the player is no longer in the group' },
  { key: 'unhosted',   label: 'Unhosted',        short: 'Unhosted',   tone: 'blue',   blurb: 'the host no longer hosts' },
];
export const STATE = Object.fromEntries(STATES.map((s) => [s.key, s]));

// States that make up the "needs action" figure. Time-barred, left and
// unhosted are real but they are not a host's to-do list.
