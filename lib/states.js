...
export const STATES = [
  ...
  { key: 'dormant',    label: 'Dormant 90d+',    short: 'Dormant',    tone: 'gray',   blurb: 'silent for 90 days or more' },
...
// States that make up the "needs action" figure. Dormant, left and unhosted
// are real but they are not a host's to-do list.
